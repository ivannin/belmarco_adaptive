...
<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<?php if ( $checkout->get_checkout_fields() ) : ?>
		...
		<div id="customer_details" class="checkout-all-fields">
      <div class="checkout-billing-fields">
        <?php do_action( 'woocommerce_checkout_billing' ); ?>
      </div>
      <div class="checkout-shipping-fields">
			  <?php echo do_shortcode('[wc_duplicate_shipmethods]');?>
        <div class="checkout-shipping-address">
          <div class="name">Ваш адрес:</div>
	...
	<?php /*<div id="order_review" class="woocommerce-checkout-review-order">
